...
# v0-06d2 production-form PyTorch runtime probe.
...
try:
    ...
    _TORCH_PROBE_MODEL.load_state_dict(torch.load(os.path.join(os.path.dirname(__file__), "pokemon-20260623-v0-06d2-torch-runtime-probe-torch_probe_state.pt"), map_location="cpu"))
