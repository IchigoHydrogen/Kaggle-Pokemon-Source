...
RUN_PREFIX = "pokemon-20260623-v0-06d2-torch-runtime-probe"
...
PROBE_ARCHIVE = WORKING_DIR / f"{RUN_PREFIX}-submission-torch-probe.tar.gz"
...
def main():
    ...
    report = {
        ...
        "purpose": "production-form PyTorch runtime feasibility",
