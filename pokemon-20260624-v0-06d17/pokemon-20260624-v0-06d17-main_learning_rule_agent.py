...
UNKNOWN0_POLICY_TABLE = {'12|13|14||safe||ko||late': '13', '12|13|14||safe||ko||mid': '13', '12|13|14||safe||no_ko||late': '13', '12|13|14|END||risk||ko||late': 'END', '12|13|14|END||safe||ko||early': 'END', '12|13|14|END||safe||ko||late': 'END', '12|13|14|END||safe||ko||mid': 'END', '12|13|14|END||safe||no_ko||late': 'END', '12|13|14|END||safe||no_ko||mid': 'END', '12|13|14|END|NO||safe||ko||late': 'END', '12|13|14|END|NO||safe||ko||mid': 'END', '12|13|14|END|NO||safe||no_ko||late': 'END', '12|13|14|END|NO|NUMBER||safe||ko||late': 'END', '12|13|14|END|NO|NUMBER|YES||safe||ko||late': 'END', '12|13|14|END|NO|YES||risk||ko||late': 'END', '12|13|14|END|NO|YES||safe||ko||late': 'END', '12|13|14|END|NO|YES||safe||ko||mid': 'END', '12|13|14|END|NO|YES||safe||no_ko||late': 'END', '12|13|14|END|NUMBER||risk||ko||late': 'END', '12|13|14|END|NUMBER||safe||ko||late': 'END', '12|13|14|END|NUMBER||safe||ko||mid': 'END', '12|13|14|END|NUMBER||thin||ko||late': 'END', '12|13|14|END|NUMBER|YES||risk||ko||late': 'END', '12|13|14|END|NUMBER|YES||safe||ko||late': 'END', '12|13|14|END|YES||safe||ko||late': 'END', '12|13|14|END|YES||safe||ko||mid': 'END', '12|13|14|END|YES||safe||no_ko||late': 'END', '14|END||safe||ko||early': 'END', '14|END||safe||ko||late': 'END', '14|END||safe||ko||mid': 'END', '14|END||safe||no_ko||late': '14', '14|END|NO||safe||ko||late': 'END', '14|END|NO||safe||ko||mid': 'END', '14|END|NO|NUMBER|YES||safe||ko||late': 'END', '14|END|NO|YES||risk||ko||late': 'END', '14|END|NO|YES||safe||ko||late': 'END', '14|END|NO|YES||safe||ko||mid': 'END', '14|END|NO|YES||safe||no_ko||late': 'END', '14|END|NUMBER|YES||safe||ko||late': 'END', '14|END|NUMBER|YES||safe||ko||mid': 'END', '14|END|YES||safe||ko||early': 'YES', '14|END|YES||safe||ko||late': 'END', '14|END|YES||safe||ko||mid': 'END', '14|END|YES||safe||no_ko||late': 'END', '12|13|14||*||*||*': '13', '12|13|14|END||*||*||*': 'END', '12|13|14|END|NO||*||*||*': 'END', '12|13|14|END|NO|YES||*||*||*': 'END', '12|13|14|END|NUMBER||*||*||*': 'END', '12|13|14|END|NUMBER|YES||*||*||*': 'END', '12|13|14|END|YES||*||*||*': 'END', '14|END||*||*||*': 'END', '14|END|NO||*||*||*': 'END', '14|END|NO|YES||*||*||*': 'END', '14|END|NUMBER|YES||*||*||*': 'END', '14|END|YES||*||*||*': 'END'}
